...
function addSquareDemo2() {
    ...
    g_basicSquareDemo2.shape = applyTransformationMatrixToAllKeypoints([[-100, -100], [100, -100], [100, 100], [-100, 100]], getScaleMatrix(.4, .4));
    g_basicSquareDemo2.shape = applyTransformationMatrixToAllKeypoints(shape1_shape, getScaleMatrix(.4, .4));

    g_basicSquareDemo2.draw();
}
addSquareDemo2();
